...
therm_all$Species <- gsub('MA', 'RI', therm_all$Species) ## Changing species code for RIHU from MAHU to RIHU from latest renaming
therm_all$Species <- gsub('BLHU', 'BLUH', therm_all$Species) ## Changing species code for RIHU from MAHU to RIHU from latest renaming

therm_all$Indiv_ID <- gsub('MA', 'RI', therm_all$Indiv_ID) ## Changing species code for RIHU from MAHU to RIHU from latest renaming
therm_all$Indiv_ID <- gsub('BLHU', 'BLUH', therm_all$Indiv_ID) ## Changing species code for RIHU from MAHU to RIHU from latest renaming

therm_all$pasted <- paste(therm_all$Indiv_ID, "_", as.character(str_pad(therm_all$Date, 4, pad = "0")), therm_all$Year, sep="")
```
